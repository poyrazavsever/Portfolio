  ...
  return (
    <>
        <div className='flex max-w-sm flex-col items-start gap-y-4 w-3/4'>
          ...
          <p className='text-white font-light text-xs sm:text-sm lg:text-base dark:text-black dark:font-semibold'>A developer based in Turkey. A Front-End developer. Always eager to learn something new, but also lazy. His computer is his best friend and companion. Do you want to know him?</p>
