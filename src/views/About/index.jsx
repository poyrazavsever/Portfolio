...
function About() {
  return (
    <div className='flex flex-col mx-auto h-screen w-full justify-center items-center gap-12 md:gap-24 relative'>
      ...
      <ShortLogo 
      className="absolute right-32 top-[40%] scale-[5] z-0 opacity-5 blur-sm"/>
