      ...
      <div className='flex sm:flex-row sm:items-start flex-col justify-center gap-24 items-center mt-8 sm:mt-24'>
        ...
        <form className='flex flex-col gap-7 items-start' ref={formRef} onSubmit={handleSubmit}>
          ...
          <label className="relative transition-all w-72 text-white dark:font-medium dark:text-black flex bg-transparent border border-linear-default dark:border-primary-200 dark:focus-within:border-linear-200 rounded-sm focus-within:border-primary-200">
            ...
            <small className="absolute top-[20px] left-[9px] cursor-text pointer-events-none text-xs text-linear-default -translate-y-1/2 transition-all peer-valid:text-[10px] peer-valid:top-2.5 dark:text-primary-200 font-medium">Message</small>

          </label>


          <button type='submit' className='border border-linear-default px-7 py-2 text-linear-default transition-all dark:border-primary-200 dark:text-primary-200 hover:text-white hover:bg-primary-200 hover:border-primary-200 rounded-sm'>Send</button>
        ...
        <div className='flex flex-col items-start gap-12'>
          ...
          <a href='mailto:poyrazavsever@gmail.com' className='flex items-start gap-x-3'>
            ...
            <div>
              <h5 className='text-linear-default dark:text-primary-200 font-semibold text-xl'>Mail</h5>
